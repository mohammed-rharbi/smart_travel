...
class ScheduleDAO extends DatabaseDAO
{
    ...
    public function addSchedule($schedule)
    {
        ...
        $query = "INSERT INTO schedule (date, departureTime, arrivalTime, availableSeats, busID, routeID ,price) 
                  VALUES (:date, :departureTime, :arrivalTime, :availableSeats, :busID, :routeID ,:price)";
        $params = [
            ':date' => $date,
